            ...
            <tr>
                <td colspan="2" style="padding-left: 200px;">
                    <form action="getAdminServlet"  method="post">
                        ...
                        <input type="hidden" name="location" value="editSelf"/>
                        <input type="submit" name="name" value="Edit"/>
                     </form>
                        <button onclick="window.location.href='AdminHome.jsp'">Back</button>
                        <button style="width: 70px;" onclick="window.location.href='AdminLogout.jsp'">Logout</button>
                        <!--<form style="float: left;">
                            <input type="submit" value="Logout" style="width: 65px;"/> 
                        </form>--->
                </td>
            </tr>
                </table>
