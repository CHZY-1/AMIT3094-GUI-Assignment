...
// Description:To perform the connection with the STAFF_ROLE table and enable it to do the CRUD operation toward the staff_role table 
package model.da;
...
public class RoleDA {
    ...
    public String newRoleID() {
        String roleID = "";
        String sqlQuery = "SELECT ROLE_ID FROM " + tableName + "";
    ...
    public static void main (String args[]){
        ...
        System.out.println(roleDA.newRoleID());
    }
