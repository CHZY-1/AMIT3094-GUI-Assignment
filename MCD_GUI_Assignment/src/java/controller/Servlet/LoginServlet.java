// Author:Lim Wei Zhe
// Description:This is a servlet for the customer side to use to login from their account. 
//             In this servlet, the moment the user have login a register will then be started 
